...
//Код вверху дает перечисление числе в обратном порядке.
//Код внизу работает только для пятизначных чисел.
...
Console.WriteLine();
Console.Write("{" + array[4] + ", " + array[3] + ", " + array[2] + ", " + array[1] + ", " + array[0] + "}");
